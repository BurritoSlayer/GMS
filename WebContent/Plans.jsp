 ...
 <div class="container">
  ...
  <div class="col-med-4 text-center">
            <!-- Trigger the modal wih a button -->
  			<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">New Plan</button>
  			
			<br>
  			<br>
  			<form method="get" action="UpdatePlan">
  				<button type="submit" class="btn btn-warning">Modify Plan</button>
  			</form>
		   </div>
		   		   <br>
		   </div>
    		 ...
    		 <div class="modal-dialog">
      			...
      			<div class="modal-content">
        			<div class="modal-header">
          			  ...
          			  <h4 class="modal-title" style="text-align: center;">Add New Plan</h4>
        			</div>
        		...
        		<div class="modal-body">
    				...
    				<form role="form" method='post' action="AddPlan">
    				<br>
					...
					<div class="row">
						<div class='col-lg-6'>
						<label for="planLName">Plan Long Name: (Optional) </label>
				    ...
				    <div class="row">
						<div class='col-lg-6'>
						<label for="discount">Plan Discount Cost: </label>
