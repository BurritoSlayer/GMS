...
<br>
  <div class="container">
  <h2>Email Lists</h2>
  <form method="post" action="EmailListController">
	<div class="radio">
  		<label><input type="radio" name="radio" value="Active">Generate all active members</label>
	</div>
	<div class="radio">
  		<label><input type="radio" name="radio" value="Discurrent">Generate members with out recent login</label>
	</div>
	<div class="radio">
  		<label><input type="radio" name="radio" value="Inactive">Generate all inactive members</label>
	</div>
