 ...
 <div class="container">
  ...
  <div class="col-med-4 text-center">
            <!-- Trigger the modal wih a button -->
  			<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">New Discipline</button>
  			
			<br>
  			<br>
  			<form method="get" action="UpdatePlan">
  				<button type="submit" class="btn btn-warning">Modify Discipline</button>
  			</form>
		   </div>
		   		   <br>
		   </div>
    		 ...
    		 <div class="modal-dialog">
        		...
        		<div class="modal-body">
    				...
    				<form role="form" method='post' action="AddDisc">
    				<br>
    				
    				<div class="row">
    					<div class='col-lg-6'>
						<label for="planName">Discipline Name: </label>
					...
					<div class="row">
						<div class='col-lg-6'>
						<label for="planLName">Description: </label>
